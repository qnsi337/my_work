...
datamodule2.ADOQuery1.SQL.Add('select * from main where [Откуда] like'+help2) ;
datamodule2.ADOQuery1.Active:=True;
end;
if edit1.Text = '' then
begin
datamodule2.ADOQuery1.SQL.Clear;
datamodule2.ADOQuery1.SQL.Add('select * from main where [Куда] like'+help4) ;
datamodule2.ADOQuery1.Active:=True;
end;
...
z4:=QuotedStr(z3);
datamodule2.ADOQuery1.SQL.Clear;
datamodule2.ADOQuery1.SQL.Add('select * from main where [Откуда] like'+z2+' and [Куда] like'+z4);
datamodule2.ADOQuery1.Active:=True;
end;
end;
...
begin
datamodule2.ADOQuery1.SQL.Clear;
datamodule2.ADOQuery1.SQL.Add('Select *from main ORDER BY [Откуда]');
datamodule2.ADOQuery1.Active:=True;
edit1.Clear;
edit2.clear;
Dbgrid1.Refresh;
